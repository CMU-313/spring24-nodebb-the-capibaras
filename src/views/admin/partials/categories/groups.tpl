...
<li data-name="{groups.displayName}">
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li role="presentation"><a href="#" data-priv="groups:posts:resolve" class="<!-- IF groups.privileges.groups:posts:resolve -->active<!-- ENDIF groups.privileges.groups:posts:resolve -->">Tag as Resolved</a></li>
